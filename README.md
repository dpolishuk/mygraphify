...
**An AI coding assistant skill.** Type `/graphify` in Claude Code, Codex, OpenCode, Cursor, Gemini CLI, GitHub Copilot CLI, Aider, OpenClaw, Factory Droid, Trae, Hermes, Kiro, Kimi CLI, or Google Antigravity - it reads your files, builds a knowledge graph, and gives you back structure you didn't know was there. Understand a codebase faster. Find the "why" behind architectural decisions.
...
**Requires:** Python 3.10+ and one of: [Claude Code](https://claude.ai/code), [Codex](https://openai.com/codex), [OpenCode](https://opencode.ai), [Cursor](https://cursor.com), [Gemini CLI](https://github.com/google-gemini/gemini-cli), [GitHub Copilot CLI](https://docs.github.com/en/copilot/how-tos/copilot-cli), [Aider](https://aider.chat), [OpenClaw](https://openclaw.ai), [Factory Droid](https://factory.ai), [Trae](https://trae.ai), [Kiro](https://kiro.dev), Kimi CLI, Hermes, or [Google Antigravity](https://antigravity.google)
...
| Kimi CLI | `graphify kimi install` |
...
**Kimi CLI** writes a `KIMI.md` section and installs a **PreToolUse hook** in `~/.kimi/config.toml` that fires before every Glob and Grep call — same always-on mechanism as Claude Code.
...
graphify kimi install               # KIMI.md + PreToolUse hook (Kimi CLI)
graphify kimi uninstall
